...
LUA_SHA1 = get_hash(os.path.join(CWD, 'codebender.lua'))
...
project = Project(
    title="codebender",
    project_html="""
        <img class="project-logo" alt="Project logo" src="http://archiveteam.org/images/9/97/Codebender_logo.png" height="50px" title=""/>
        <h2>codebender.cc <span class="links"><a href="http://codebender.cc/">Website</a> &middot; <a href="http://tracker.archiveteam.org/codebender/">Leaderboard</a></span></h2>
        <p>Archiving code from codebender.co.</p>
    """
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker("http://%s/%s" % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix="codebender"),
    WgetDownload(
        WgetArgs(),
        max_tries=2,
